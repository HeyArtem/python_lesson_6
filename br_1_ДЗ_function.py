...
import random
def f(z):
    """Список случайных имен длиной z"""
    sps_list = (['Зина', 'Артур', 'Илья', 'Семен', 'Просковья', 'Маргарита',
             'Альберт', 'Просковья', 'Фрэнк', 'Артем', 'Дмитрий', 'София',
             'Ева', 'Ромео', 'Джульетта', 'Фокс', 'Карбофос', 'Фунтик', 'Том',
             'Джери'])
    rnd_list = []
    rnd_list = random.choices(sps_list, k=z)
    return rnd_list
print(f(80))